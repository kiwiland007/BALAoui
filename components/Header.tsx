        ...
        >
          ...
          {logoUrl && logoUrl.startsWith('http') ? (
            <img
              ...
              onError={(e) => {
                ...
                if (parent) {
                  ...
                  fallback.innerHTML = '<i class="fa-solid fa-tags text-primary text-3xl -rotate-90 mr-2"></i><h1 class="text-3xl font-bold text-primary">BALAoui</h1>';
            ...
            <div className="flex items-center">
              <i className="fa-solid fa-tags text-primary text-3xl -rotate-90 mr-2"></i>
