...
import { ProductStatus, ShippingMethod } from '../types';
...
interface ProductDetailPageProps {
  ...
  onPurchase: (product: Product, buyerProtectionFee: number, shippingFee: number, totalAmount: number, shippingMethod: ShippingMethod) => void;
...
const ProductDetailPage: React.FC<ProductDetailPageProps> = ({ product, allProducts, savedItems, cartItems, onBack, onSellerClick, onProductSelect, onToggleSave, onAddToCart, onPurchase, currentUser, onReportProduct, onMessageSeller, showToast, appSettings }) => {
  ...
  const handleConfirmPurchase = (product: Product, buyerProtectionFee: number, shippingFee: number, totalAmount: number, shippingMethod: ShippingMethod) => {
    setIsCheckoutOpen(false);
    onPurchase(product, buyerProtectionFee, shippingFee, totalAmount, shippingMethod);
  }
